...
function Solutions() {
  return (
    <div className='mt-10'>
      ...
      <h2 className='text-3xl sm:text-5xl lg:text-6xl text-center mt-6 tracking-wide'>Make your <span className='bg-gradient-to-r from-blue-600 to-blue-900 text-transparent bg-clip-text'>Product look better</span>
    </h2>
